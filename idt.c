...
void init_idt(void)
{
    ...
    init_idt_desc(0x08, (u32)_asm_exc_GP, 0x8E00, &kidt[13]);    /* #GP */
    init_idt_desc(0x08, (u32)_asm_exc_PF, 0x8E00, &kidt[14]);    /* #PF */

    /* Interrupciones de hardware */
    init_idt_desc(0x08, (u32)_asm_irq_0, 0x8E00, &kidt[32]);     /* IRQ0 */
    init_idt_desc(0x08, (u32)_asm_irq_1, 0x8E00, &kidt[33]);     /* IRQ1 */
